...
def processor(mock_nemo_model):
    # We patch the import location of ASRModel.from_pretrained
    with patch("nemo.collections.asr.models.ASRModel.from_pretrained", return_value=mock_nemo_model):
        #its good practice to also mock this for model training 
