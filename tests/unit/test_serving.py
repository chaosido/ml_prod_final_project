...
def test_predict_flow(mock_acoustic_cls, mock_get_asr, mock_get_loader, mock_sf_read):
    ...
    # 5. Execute Request
    files = {
        "audio_file": ("test_audio.wav", b"fake_content", "audio/wav")
    }
...
@patch("serving.main.get_asr_processor")
@patch("serving.main.AcousticFeatureExtractor")
def test_predict_bad_quality(mock_acoustic_cls, mock_get_asr, mock_get_loader, mock_sf_read):
    ...
    mock_get_asr.return_value.process.return_value = {"transcription": "", "asr_confidence": 0.1}
